        ...
        return `
            <div class="chat">
                <div class="chat__user-header">
                    ...
                    <div class="popup-wrapper chat__user-more-wrapper">
                        <button title="Опции" class="chat__user-button-more" type="button">
                        ...
                        <ul class="popup popup--active chat__header-more-popup">
                            <li class="popup-item">
                                <button type="button" class="text-5 popup-button">
                ...
                <div class="chat__main">
                        {{{ Button label=count onClick=increase label="Добавить" }}}
                ...
                <form class="chat__footer" method="POST" action="/">
                    <div class="popup-wrapper chat__footer-button-attach-wrapper">
                        <ul class="popup popup--active chat__footer-attach-popup">
                            <li class="popup-item chat__footer-attach-item">
                                <button type="button" class="text-5 popup-button chat__footer-button-attach-item-button">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <button title="Вложения" type="button" class="chat__footer-button-attach">
                    ...
                    <input type="text" name="message" class="input input-outlined chat__footer-search" placeholder="Сообщение" />
                    <button type="submit" class="chat__footer-button-submit">
